...
The Head of Lending has asked the team to quantify expected total profit under each threshold and to state — with numbers — which threshold Ledge & Lend Group should adopt.
