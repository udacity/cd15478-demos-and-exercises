...
9. **Sensitivity check**: recompute the ROI assuming the true causal effect equals the known
   experimental benchmark ($1,794). Report whether the program's ROI changes sign.
...
- The ROI sensitivity check must quantify the difference between the IPW-based ROI and
